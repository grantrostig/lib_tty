...
using Chars 	= std::vector< KbFundamentalUnit >;   /// A sequence of basic chars that are generated by a user single keypress of a Hot_key on a keyboard, ie. ESC, or F1 for help. but does not include a or 2 or /
...
}; using Hot_key_table = std::vector< Hot_key_row >;                            // Stores all known Hot_key_rows for internal library use.
...
class Key_char_singular2 : public My_base {
...
class Hot_key_multi_char            : public My_base {  // tag type if {};
    Hot_key_row         hot_key_row;
};
class Hot_key_multi_char_manual     : public Hot_key_multi_char {  // entered by hand one char by char
};
class I18n_multi_char               : public My_base {
    Key_chars_i18n      characters;
};
class I18n_multi_char_manual        : public I18n_multi_char {
};
class I18n_multi_char_partial       : public I18n_multi_char_manual {
};
class Hot_key_multi_char_partial    : public My_base {
};

class Hot_key_multi_char_error {
};
class I18n_multi_char_error {
};
