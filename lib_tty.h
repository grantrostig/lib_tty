 ...
 */
using Kb_key_variant = std::variant< std::monostate, Key_char_singular, Hot_key_chars, Hot_key, File_status >;  // todo: only Key_char_singular and File_status is used internally in Lib_tty, so maybe refactor?
...
/** Seeks to get n Key_char_singulars from keyboard in raw stty mode.
