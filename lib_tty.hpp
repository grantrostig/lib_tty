...
using I18n_key_chars 	= std::vector< KbFundamentalUnit >;   // One or a sequence of basic chars that are entered or generated by a user using international KB characters.
